  ...
  <div class="modal-backdrop" id="detailModal" role="dialog" aria-modal="true" aria-labelledby="detailTitle">
    <div class="modal-container modal-detail-container">
      ...
      <div class="modal-body">
          ...
          <div class="detail-seller-left">
            ...
            <div class="detail-seller-info">
              <div class="detail-seller-name-row">
                ...
                <span class="detail-seller-verified-badge"><i class="fa-solid fa-shield-halved"></i> ยืนยันแล้ว</span>
              </div>
        ...
        <!-- Specifications & Authenticated Provenance Checklist -->
        <h4 class="detail-specs-heading">
          <i class="fa-solid fa-list-check" style="color: var(--accent-gold);"></i> ข้อมูลจำเพาะและการรับประกันสินค้า
        </h4>
        <ul id="detailSpecs" class="detail-specs-list">
          <!-- Populated dynamically via JS -->
        </ul>

        <!-- Timeline & Pricing Summary Box -->
        <div class="auction-dates detail-dates-box">
          <div class="date-row">
            <span class="label"><i class="fa-regular fa-calendar-check"></i> เริ่มเปิดการประมูล</span>
            <span class="value" id="detailStartDate">-</span>
          </div>
          <div class="date-row">
            <span class="label"><i class="fa-solid fa-flag"></i> ราคาเริ่มต้นขั้นต่ำ</span>
            <span class="value" id="detailStartPrice" style="color: var(--accent-gold);">-</span>
          </div>
          <div class="date-row" style="grid-column: 1 / -1; margin-top: 6px;">
            <span class="label"><i class="fa-regular fa-calendar-xmark"></i> สิ้นสุดการประมูลวันที่</span>
